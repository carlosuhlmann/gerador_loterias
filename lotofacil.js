...
var numeroSorteado = Math.round(Math.random() * 24 + 1);
    jogo[0] = numeroSorteado;
    var i = 1;

    while (i < qtd) {
        var j = 0;
        numeroSorteado = Math.round(Math.random() * 24 + 1);
            while (j < i) {
        ...
        if(qtd==20){
            mostrar = `${jogo[0]} - ${jogo[1]} - ${jogo[2]} - ${jogo[3]} - ${jogo[4]} - ${jogo[5]} - ${jogo[6]} - ${jogo[7]} - ${jogo[8]} - ${jogo[9]} - ${jogo[10]} - ${jogo[11]} - ${jogo[12]} - ${jogo[13]} - ${jogo[14]} - ${jogo[15]} - ${jogo[16]}- ${jogo[17]} - ${jogo[18]} - ${jogo[19]}`;
        }

        else if(qtd==19){
            mostrar = `${jogo[0]} - ${jogo[1]} - ${jogo[2]} - ${jogo[3]} - ${jogo[4]} - ${jogo[5]} - ${jogo[6]} - ${jogo[7]} - ${jogo[8]} - ${jogo[9]} - ${jogo[10]} - ${jogo[11]} - ${jogo[12]} - ${jogo[13]} - ${jogo[14]} - ${jogo[15]} - ${jogo[16]}- ${jogo[17]} - ${jogo[18]}`;
        }

        else if(qtd==18){
            mostrar = `${jogo[0]} - ${jogo[1]} - ${jogo[2]} - ${jogo[3]} - ${jogo[4]} - ${jogo[5]} - ${jogo[6]} - ${jogo[7]} - ${jogo[8]} - ${jogo[9]} - ${jogo[10]} - ${jogo[11]} - ${jogo[12]} - ${jogo[13]} - ${jogo[14]} - ${jogo[15]} - ${jogo[16]}- ${jogo[17]}`;
        }

        else if(qtd==17){
            mostrar = `${jogo[0]} - ${jogo[1]} - ${jogo[2]} - ${jogo[3]} - ${jogo[4]} - ${jogo[5]} - ${jogo[6]} - ${jogo[7]} - ${jogo[8]} - ${jogo[9]} - ${jogo[10]} - ${jogo[11]} - ${jogo[12]} - ${jogo[13]} - ${jogo[14]} - ${jogo[15]} - ${jogo[16]}`;
        }

        else if(qtd==16){
            mostrar = `${jogo[0]} - ${jogo[1]} - ${jogo[2]} - ${jogo[3]} - ${jogo[4]} - ${jogo[5]} - ${jogo[6]} - ${jogo[7]} - ${jogo[8]} - ${jogo[9]} - ${jogo[10]} - ${jogo[11]} - ${jogo[12]} - ${jogo[13]} - ${jogo[14]} - ${jogo[15]}`;
        }
